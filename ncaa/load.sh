...
psql basketball-m -f schema/create_schema_ncaa.sql

tail -q -n+2 csv/ncaa_games_*[0-9].csv > /tmp/ncaa_games.csv
psql basketball-m -f loaders/load_ncaa_games.sql
...
psql basketball-m -f loaders/load_ncaa_statistics.sql
rm /tmp/ncaa_statistics.csv

psql basketball-m -f schema/create_ncaa_players.sql

cp csv/ncaa_schools.csv /tmp/ncaa_schools.csv
psql basketball-m -f loaders/load_ncaa_schools.sql
rm /tmp/ncaa_schools.csv

cp csv/ncaa_divisions.csv /tmp/ncaa_divisions.csv
psql basketball-m -f loaders/load_ncaa_divisions.sql
rm /tmp/ncaa_divisions.csv

cp csv/ncaa_colors.csv /tmp/ncaa_colors.csv
psql basketball-m -f loaders/load_ncaa_colors.sql
rm /tmp/ncaa_colors.csv

cp csv/ncaa_geocodes.csv /tmp/ncaa_geocodes.csv
psql basketball-m -f loaders/load_ncaa_geocodes.sql
